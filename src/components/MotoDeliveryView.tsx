...
export const MotoDeliveryView: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-emerald-600 via-emerald-500 to-green-500 p-6 sm:p-8 text-black shadow-2xl text-center space-y-3">
        <div className="w-16 h-16 mx-auto rounded-full bg-black/10 flex items-center justify-center">
          <Package className="w-9 h-9 text-black" />
        </div>
        <div>
          <span className="text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-black/10">
      ...
      {deliverySent && (
        <div className="p-4 rounded-2xl bg-emerald-500 text-black font-extrabold text-xs flex items-center justify-between shadow-xl animate-in zoom-in">
      ...
      {/* Main Delivery Form */}
      <div className="p-6 rounded-3xl bg-gray-900 border border-gray-800 shadow-2xl space-y-5">
        {/* Addresses */}
        <div className="space-y-3">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-2xl text-white font-bold text-xs focus:outline-none focus:border-emerald-500"
            >
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-2xl text-white font-bold text-xs focus:outline-none focus:border-amber-500"
            >
              {MAPUTO_LOCATIONS.map((loc) => (
                <option key={loc.name} value={loc.name}>
                  {loc.name} - {loc.address}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <div>
            <label className="text-[11px] font-bold text-gray-300 block mb-1">Nome do destinatário</label>
            <div className="relative">
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-white text-xs font-bold focus:outline-none focus:border-emerald-500"
              />
          ...
          <div>
            <label className="text-[11px] font-bold text-gray-300 block mb-1">Celular do destinatário</label>
            <div className="relative">
              <input
                type="tel"
        ...
        <div className="space-y-2 pt-2">
          <label className="text-xs font-bold text-gray-300">Tipo de pacote</label>
          <div className="grid grid-cols-3 gap-2">
            ...
            >
              ...
              <div className="text-[10px] text-emerald-400 font-bold mt-0.5">Até 5kg</div>
              <div className="text-xs font-black text-white mt-1">100,00 MT</div>
            </button>
            ...
            >
              ...
              <div className="text-[10px] text-emerald-400 font-bold mt-0.5">Até 15kg</div>
              <div className="text-xs font-black text-white mt-1">200,00 MT</div>
            </button>
            ...
            >
              ...
              <div className="text-[10px] text-emerald-400 font-bold mt-0.5">Até 30kg</div>
              <div className="text-xs font-black text-white mt-1">350,00 MT</div>
            </button>
          </div>
        </div>
        ...
        <div className="space-y-1">
          <label className="text-[11px] font-bold text-gray-300 block">Observações (opcional)</label>
          <div className="relative">
            <textarea
              rows={2}
              value={observations}
              ...
              className="w-full p-3 bg-gray-800 border border-gray-700 rounded-xl text-white text-xs focus:outline-none focus:border-emerald-500 resize-none"
            />
          </div>
        </div>
        ...
        <button
          ...
          className="w-full py-4 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-black font-extrabold text-sm shadow-xl shadow-emerald-500/25 transition-all uppercase tracking-wider flex items-center justify-center gap-2"
        >
